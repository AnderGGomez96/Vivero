	...
	<body>
		<div>
			<table align="center">
				...
				<BR>
				<tr><td><input type="button" name="cultivo" value="Cultivo" onclick="window.location.href='Lista/lista_cultivo.php'"></td>
				...
				<td><input type="button" name="planta" value="Planta" onclick="window.location.href='Lista/lista_planta.php'"></td></tr>
				<td><input type="button" name="ventas" value="Ventas" onclick="window.location.href='Lista/lista_ventas.php'"></td></tr>
			</table>
		</div>
	</body>
</html>